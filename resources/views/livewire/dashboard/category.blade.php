    ...
    <div x-show="showDeleteModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black/50"
        ...
        <div class="relative p-5 border w-96 shadow-lg rounded-md bg-white">
            <div class="mt-3">
                ...
                <h3 class="text-lg font-medium leading-6 text-gray-900 text-center mb-2">Hapus Kategori</h3>
                <p class="text-sm text-gray-500 text-center mb-5">Apakah kamu yakin ingin menghapus kategori ini? Tindakan
