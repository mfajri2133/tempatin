<div class="bg-white rounded shadow-md border border-blue-100 overflow-hidden">
    ...
    <!-- FORM -->
    <form wire:submit.prevent="save" class="p-6 space-y-4" autocomplete="off">
        ...
        <div class="space-y-1">
            ...
            <input type="number" wire:model.live.debounce.300ms="price_per_hour" placeholder="Masukkan harga"
                class="w-full h-10 px-3 text-sm rounded-md border border-gray-300
                       focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500
        ...
        <div class="flex justify-end gap-2 pt-4">
            <x-button-add href="{{ route('venues.index') }}"
