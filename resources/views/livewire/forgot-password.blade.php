    ...
    <div class="w-full max-w-md">
        <div class="bg-white rounded-lg shadow-md border border-gray-200 p-6">
            ...
            <form wire:submit.prevent="submit" class="space-y-4">
                <div class="space-y-1">
                    ...
                    <div class="relative">
                        ...
                        <input type="email" wire:model.defer="email" required placeholder="example@email.com"
            ...
            <div class="mt-6 flex justify-center">
                <a href="{{ route('login') }}"
                    class="flex items-center gap-1 text-xs text-indigo-600 hover:text-indigo-700 font-medium hover:underline">
