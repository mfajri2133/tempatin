    ...
    <div class="w-full max-w-md">
        ...
        <div class="bg-white rounded-lg shadow-md border border-gray-200 p-6">
            ...
            <div class="mb-6">
                ...
                <p class="text-sm text-gray-600 mt-1">Buat akun untuk mulai memesan tempat acara</p>
            </div>
                ...
                <div class="space-y-1">
                    ...
                    <div class="relative" x-data="{ showPasswordConfirm: false }">
                        ...
                        <input :type="showPasswordConfirm ? 'text' : 'password'" id="password_confirmation"
                            wire:model.defer="password_confirmation" required placeholder="Ulangi password"
                            class="w-full h-10 pl-10 pr-10 text-sm rounded-md
                                   border border-gray-300
                                   bg-white text-gray-900
                                   placeholder:text-gray-400
