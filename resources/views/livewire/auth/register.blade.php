    ...
    <div class="bg-white rounded-2xl shadow-2xl p-8">
        ...
        <form wire:submit.prevent="register" class="space-y-4 mb-6">
            ...
            <div>
                ...
                <input type="text" id="name" wire:model="name" required
                    class="w-full text-black px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200"
        ...
        <div class="space-y-3">
            ...
            <a href="{{ route('socialite.redirect', 'github') }}"
                ...
                <span class="font-medium">Daftar dengan GitHub</span>
            </a>
        </div>
