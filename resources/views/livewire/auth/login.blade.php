    ...
    <div class="bg-white rounded-2xl shadow-2xl p-8">
        ...
        <div class="space-y-4">
            ...
            <a href="{{ route('socialite.redirect', 'github') }}"
                ...
                <span class="font-medium">Login dengan GitHub</span>
            </a>
        </div>
        ...
        <p class="text-center text-sm text-gray-600">
            Dengan login, Anda menyetujui <a href="#" class="text-blue-600 hover:underline">Terms of Service</a>
            dan <a href="#" class="text-blue-600 hover:underline">Privacy Policy</a>
        </p>
    </div>
</div>
