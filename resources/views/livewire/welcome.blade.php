    ...
    <section class="w-full min-h-screen bg-cover bg-center flex items-center justify-center"
        ...
        <div class="relative z-20 w-full max-w-5xl px-6 text-center text-white">
            ...
            <h1 class="text-3xl md:text-5xl font-semibold mb-10">
                Sewa Tempat Impianmu untuk acara anak muda tak terlupakan
            </h1>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div class="order-2 lg:order-1">
                    ...
                    <p class="mt-8 text-gray-600 text-lg max-w-md leading-relaxed font-medium">
                        Temukan Venue berkualitas di Jawa Barat untuk setiap kebutuhan seperti Corporate Event, Celebration, hingga Sports Activity.
                    </p>
                    
                    <div class="flex flex-wrap gap-x-6 gap-y-4 border-t border-gray-800 pt-10 mt-10">
                        <span class="text-gray-500 text-xs uppercase  font-bold hover:text-indigo-500">Aula</span>
                        <span class="text-gray-500 text-xs uppercase  font-bold hover:text-indigo-500">Co-Working Space</span>
                        <span class="text-gray-500 text-xs uppercase  font-bold hover:text-indigo-500">Convention Hall</span>
                        <span class="text-gray-500 text-xs uppercase  font-bold hover:text-indigo-500">Event Space</span>
                        <span class="text-gray-500 text-xs uppercase  font-bold hover:text-indigo-500">Gedung Serbaguna</span>
                        <span class="text-gray-500 text-xs uppercase  font-bold hover:text-indigo-500">Lapangan</span>
                        <span class="text-gray-500 text-xs uppercase  font-bold hover:text-indigo-500">Outdoor Venue</span>
                        <span class="text-gray-500 text-xs uppercase  font-bold hover:text-indigo-500">Ruang Meeting</span>
                    </div>
                </div>
